...
void CubismRenderer_OpenGLES2::SetRenderPartIdx(csmInt32 renderIdx)
{
    _renderPartIdx = renderIdx;
}

void CubismRenderer_OpenGLES2::SetRenderDrawableIdx(csmInt32 renderIdx)
{
    _renderDrawableIdx = renderIdx;
}
...
void CubismRenderer_OpenGLES2::DoDrawModel()
{
    ...
    for (csmInt32 i = 0; i < drawableCount; ++i)
    {
        ...
        if (_renderDrawableIdx >= 0 && i != _renderDrawableIdx) {
            continue;
        }
